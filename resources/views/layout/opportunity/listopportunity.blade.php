                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <table style="width:100%">
                                <tr>
                                    <th style="color: red">
                                        <div style="margin-bottom: 20px;margin-right: 15px;margin-top: 15px">آی دی
                                            فرصت
                                        </div>
                                    </th>
                                    <th style="color: red">
                                        <div style="margin-bottom: 20px;margin-top: 15px"> آی دی خریدار</div>
                                    </th>
                                    <th style="color: red">
                                        <div style="margin-bottom: 20px;margin-top: 15px"> آی دی محصول</div>
                                    </th>
                                    <th style="color: red">
                                        <div style="margin-bottom: 20px;margin-top: 15px">تعداد</div>
                                    </th>
                                    <th style="color: red">
                                        <div style="margin-bottom: 20px;margin-top: 15px">قیمت کل</div>
                                    </th>
                                    <th style="color: red">
                                        <div style="margin-bottom: 20px;margin-top: 15px">وضعیت</div>
                                    </th>
                                    <th style="color: red">
                                ...
                                @foreach($oppos as $oppo)
                                    <tr>
                                        <td>
                                            <div style="margin-right: 15px">{{$oppo->id}}</div>
                                        </td>
                                        <td>
                                            <div style="margin-bottom: 15px">{{$oppo->customer_id}}</div>
                                        </td>
                                        <td>
                                            <div style="margin-bottom: 15px">{{$oppo->product_id}}</div>
                                        </td>
                                        <td>
                                            <div style="margin-bottom: 15px">{{$oppo->number}}</div>
                                        </td>
                                        <td>
                                            <div style="margin-bottom: 15px">{{$oppo->total_price}}</div>
                                        </td>
                                        <td>
                                            <div style="margin-bottom: 15px">{{$oppo->status}}</div>
                                        </td>
                                        <td>
