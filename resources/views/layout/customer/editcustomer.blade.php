                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{route('edited_customer',['id' => $customers->id])}}"
                                  method="POST">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="fname" type="text" class="form-control"
                                               value="{{$customers->fname}}" placeholder="نام خانوادگی را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">نام پدر</label>
                                        <input name="dadname" type="text" class="form-control"
                                               value="{{$customers->dadname}}" placeholder="نام پدر را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">آدرس ایمیل</label>
                                        <input name="email" type="email" class="form-control"
                                               value="{{$customers->email}}" placeholder="ایمیل را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="country" type="text" class="form-control"
                                               value="{{$customers->country}}" placeholder="کشور را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">شهر</label>
                                        <input name="City" type="text" class="form-control" value="{{$customers->City}}"
                                               placeholder="شهر را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                        <label>آدرس</label>
                                        <textarea name="Address" class="form-control" rows="3"
                                                  placeholder="آدرس را کامل وارد کنید">{{$customers->Address}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>جنسیت</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="nationalcode" type="number" class="form-control"
                                               value="{{$customers->nationalcode}}" placeholder="کد ملی را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">شغل</label>
                                        <input name="job" type="text" class="form-control" value="{{$customers->job}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="image" type="text" class="form-control"
                                               ...
                                               placeholder="لینک عکس مورد نظر را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                        <label>تحصیلات</label>
                                        <select name="education" class="form-control">
                                            <option {{$customers->education == 'زیر دیپلم'?'selected':''}}>زیر دیپلم
                                            </option>
                                            <option {{$customers->education == 'دیپلم'?'selected':''}}>دیپلم</option>
                                            <option {{$customers->education == 'کارشناسی'?'selected':''}}>کارشناسی
                                            </option>
                                            <option {{$customers->education == 'کارشناسی ارشد'?'selected':''}}>کارشناسی
                                                ارشد
                                            </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="cityofeducation" type="text" class="form-control"
                                               value="{{$customers->cityofeducation}}"
                                               placeholder="شهر محل تحصیل را وارد کنید">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">رمز عبور</label>
                                        <input name="password" type="password" class="form-control"
                                               value="{{$customers->password}}" placeholder="رمز را وارد کنید">
                                    </div>
