                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="fname" type="text" class="form-control"
                                                   id="exampleInputPassword1" placeholder="نام خانوادگی را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">نام پدر</label>
                                            <input name="dadname" type="text" class="form-control"
                                                   id="exampleInputPassword1" placeholder="نام پدر را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">آدرس ایمیل</label>
                                            <input name="email" type="email" class="form-control"
                                                   id="exampleInputPassword1" placeholder="ایمیل را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">شماره تماس</label>
                                            <input name="phonenumber" type="number" class="form-control"
                                                   id="exampleInputPassword1" placeholder="شماره تماس را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">کشور</label>
                                            <input name="country" type="text" class="form-control"
                                                   id="exampleInputPassword1" placeholder="کشور را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">شهر</label>
                                            <input name="City" type="text" class="form-control"
                                                   id="exampleInputPassword1" placeholder="شهر را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label>آدرس</label>
                                            <textarea name="Address" class="form-control" rows="3"
                                                      placeholder="آدرس را کامل وارد کنید"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>جنسیت</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="nationalcode" type="number" class="form-control"
                                                   id="exampleInputPassword1" placeholder="کد ملی را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">شغل</label>
                                            <input name="job" type="text" class="form-control"
                                                   id="exampleInputPassword1" placeholder=" شغل را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="imageUpload">آپلود عکس</label>
                                            <input name="image" type="text" class="form-control" id="imageUpload"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="cityofeducation" type="text" class="form-control"
                                                   id="exampleInputPassword1" placeholder="شهر محل تحصیل را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">رمز عبور</label>
                                            <input name="password" type="password" class="form-control"
                                                   id="exampleInputPassword1" placeholder="رمز را وارد کنید">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">تکرار رمز عبور</label>
                                            <input name="confrim" type="password" class="form-control"
                                                   id="exampleInputPassword1" placeholder="رمز را تکرار کنید">
                                        </div>
